...
const Contact = () => {
  return (
    <div className="container max-w-5xl mx-auto my-4 rounded bg-white flex justify-center px-2 my-8">
    <div className="w-full sm:w-1/2 -mx-5">
      <div className="px-5">
        <h2 className="leading-relaxed font-bold text-gray-900 text-3xl sm:text-4xl sm:leading-7 mb-2">Contact me</h2>
